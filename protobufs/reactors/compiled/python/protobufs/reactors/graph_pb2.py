...
# source: protobufs/reactors/graph.proto
...
Node = _reflection.GeneratedProtocolMessageType('Node', (_message.Message,), dict(
  DESCRIPTOR = _NODE,
  __module__ = 'protobufs.reactors.graph_pb2'
